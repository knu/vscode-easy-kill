...
- **30+ selection types**: subword, word, symbol, line, sentence, paragraph, sexp, defun, function, block, string, parentheses, brackets, curlies (with/without delimiters), buffer, filename, URL, email, character search, and more
...
- **Set Count** (1-9) - Set selection count (e.g., `3` selects 3 instances)
...
- **Word** (W) - Vim-style WORD (non-whitespace)
- **Symbol** (s) - Programming language identifier
